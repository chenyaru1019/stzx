<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SProjectCost.aspx.cs" Inherits="OThinker.H3.Portal.Sheets.DefaultEngine.SProjectCost" EnableEventValidation="false" MasterPageFile="~/MvcSheet.master" %>
...
序号								</td>
								...
								<td id="Control15_Header9" data-datafield="ZProjectCostList.LastMonthTax">
									<label id="Control15_Label9" data-datafield="ZProjectCostList.LastMonthTax" data-type="SheetLabel" style="">上月税</label>
								</td>
								<td id="Control15_Header10" data-datafield="ZProjectCostList.Total">
...
序号								</td>
								...
								<td id="Control17_Header9" data-datafield="PProjectCostList.LastMonthTax">
									<label id="Control17_Label9" data-datafield="PProjectCostList.LastMonthTax" data-type="SheetLabel" style="">上月税</label>
								</td>
								<td id="Control17_Header10" data-datafield="PProjectCostList.Total">
