<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SExpertNomination.aspx.cs" Inherits="OThinker.H3.Portal.Sheets.DefaultEngine.SExpertNomination" EnableEventValidation="false" MasterPageFile="~/MvcSheet.master" %>
...
<span class="OnlyDesigner">Originator.OUName</span>
			...
			<div class="divContent" id="divSheet">
				...
				<div class="row">
					...
					<select data-datafield="Sex" data-type="SheetDropDownList" id="ctl523851" class="" style="" data-defaultitems="男;女" data-queryable="false" data-emptyitemtext="请选择"></select></div>
				...
				<div class="row">
					...
					<div id="div991394" class="col-md-4">
						<input id="Control24" type="text" data-datafield="Lxdh" data-type="SheetTextBox" style="" class="" data-regularexpression="/^1[3|4|5|8][0-9]{9}$/" data-regularinvalidtext="请输入一个有效的手机号码.">
					</div>
					...
					<div id="div192058" class="col-md-4">
						<input id="Control25" type="text" data-datafield="Yx" data-type="SheetTextBox" style="" class="" data-regularexpression="/^\w+([-+.]\w+)*@\w+([-.]\\w+)*\.\w+([-.]\w+)*$/" data-regularinvalidtext="请输入一个有效的邮箱地址.">
					</div>
				</div>
				<div class="row">
