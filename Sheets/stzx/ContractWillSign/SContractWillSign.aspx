<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SContractWillSign.aspx.cs" Inherits="OThinker.H3.Portal.Sheets.stzx.SContractWillSign" EnableEventValidation="false" MasterPageFile="~/MvcSheet.master" %>
...
<style>
    ...
    #ContractMsg #title8 #div218708 {
        border-right: 1px solid #E3E3E3;
        height: 80px;
    }
    #ContractMsg #control8 {
        padding: 0;
    }
    #ContractMsg #control8 .col-md-12 {
        padding: 0;
        border-left: 0;
        border-bottom: 1px solid #E3E3E3;
    }
    #ContractMsg #control8 .col-md-12 #title9,#ContractMsg #control8 .col-md-12 #title11 {
        border-left: 0px;
        border-right: 1px solid #E3E3E3;
    }
</style>
<div style="text-align: center;" class="DragContainer">
	<label id="lblTitle" class="panel-title">合同会签</label>
</div>
...
<!--<span class="OnlyDesigner">Originator.OUName</span>-->
		...
		<div class="divContent" id="divSheet">
			...
			<div class="row">
				<div id="div590662" class="col-md-2"  style="border-right: 1px solid #E3E3E3;">
			...
			<div class="row">
				<div id="div948430" class="col-md-2"  style="border-right: 1px solid #E3E3E3;">
					<span id="Label14" data-type="SheetLabel" data-datafield="ProjectNum" class="">项目编号</span>
				</div>
				<div id="div923641" class="col-md-3">
