            ...
            $http({
             ...
             .success(function (result, header, config, status) {
                 ...
                 angular.forEach($scope.WebParts, function (data, index, full) {
                     ...
                     htmlPart.append("<div web-part-init=\"" + data.ObjectID + "\"  web-index=\"" + index + "\" class='divBox'></div>");
                 })
...
//插件初始化
app.directive('webPartInit', ['$interval', '$timeout', '$http', 'ControllerConfig', function ($interval, $timeout, $http, ControllerConfig) {
    return {
        restrict: 'A',
        scope: true,
