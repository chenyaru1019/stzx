//已阅-分组模式
app.controller('MyReadWorkItemControllerByGroup', ['$scope', "$rootScope", "$translate", "$http", "$state", "$compile", "$interval", "ControllerConfig", "jq.datables",
    function ($scope, $rootScope, $translate, $http, $state, $compile, $interval, ControllerConfig, jqdatables) {
        ...
        $scope.loadData = function (init) {
            var url = "/Portal/Sheets/handlers/WorkflowHandler.ashx?Command=GetReadWorkItemsByGroup";
        ...
        $scope.getColumns = function () {
            ...
            columns.push({ "mData": "Name", "sClass": "hide1024", });
            return columns;
        };
