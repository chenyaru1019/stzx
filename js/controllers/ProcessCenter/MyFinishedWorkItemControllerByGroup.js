//已办-分组模式
app.controller('MyFinishedWorkItemControllerByGroup', ['$scope', "$rootScope", "$translate", "$http", "$state", "$compile", "$interval", "ControllerConfig", "jq.datables",
    function ($scope, $rootScope, $translate, $http, $state, $compile, $interval, ControllerConfig, jqdatables) {
        ...
        $scope.loadData = function (init) {
            var url = "/Portal/Sheets/handlers/WorkflowHandler.ashx?Command=GetFinishWorkItemsByGroup";
