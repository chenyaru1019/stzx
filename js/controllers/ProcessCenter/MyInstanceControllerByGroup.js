//我的流程-分组模式
app.controller('MyInstanceControllerByGroup', ['$scope', "$rootScope", "$translate", "$http", "$state", "$compile", "$interval", "ControllerConfig", "jq.datables",
    function ($scope, $rootScope, $translate, $http, $state, $compile, $interval, ControllerConfig, jqdatables) {
        ...
        $scope.loadData = function (init) {
            var url = "/Portal/Sheets/handlers/WorkflowHandler.ashx?Command=QueryMyInstanceByGroup";
        ...
        $scope.getColumns = function () {
            ...
            //     }
            // });
            columns.push({ "mData": "CreatedTime", "sClass": "hide414", });
            columns.push({ "mData": "OriginatorName", "sClass": "hide414", });
            columns.push({ "mData": "ApproverLink", "sClass": "hide1024", });
            columns.push({ "mData": "Approver", "sClass": "hide1024", });
            //流程状态
            columns.push({
                "mData": "State",
