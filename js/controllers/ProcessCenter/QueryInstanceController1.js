        ...
        $scope.getColumns = function () {
            ...
            columns.push({
                ...
                "mRender": function (data, type, full) {
                    ...
                    return "<span id=\"tooltip\" data-toggle=\"tooltip\" data-placement=\"left\" class='ApproverOuDept InstanceExceptionInfo' title=\"" + data + "\">" + text + "</span>";
                }
            });
        ...
        $scope.tabQueryInstance = {
            ...
            "initComplete": function (settings, json) {
                ...
                filter.find("button").unbind("click.DT").bind("click.DT", function () {
                    ...
                    // console.log($scope.WorkflowCode);
                });
