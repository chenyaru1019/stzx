<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SEvaluationResult.aspx.cs" Inherits="OThinker.H3.Portal.Sheets.DefaultEngine.SEvaluationResult" EnableEventValidation="false" MasterPageFile="~/MvcSheet.master" %>
