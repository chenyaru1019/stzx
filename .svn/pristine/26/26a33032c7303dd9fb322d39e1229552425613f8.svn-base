...
Sheet.Computation.prototype = {
    init: function (o) {
        this.RegisterEventRules = [];
        this.RegisterEventOnLoad = [];
        $(":input[" + this.AttrName + "],span[" + this.AttrName + "],textarea[" + this.AttrName + "]").each(function (e) {
        ...
        */
        ...
        for (var i = 1; i < fieldArray.length; i++) {
            ...
            if (eventExpress.indexOf(",") > -1) {
                ...
                var dataFieldObject = $("input[" + this.AttrDataField + "='" + dataField + "'],span[" + this.AttrDataField + "='" + dataField + "']");
            }
    ...
    executeCompute: function (id, round, express) {
        ...
        while (express.length > 0) {
            ...
            if (i == "{") {
                ...
                executeExpress = executeExpress + "(" + CompuationFun[0].Compuator(this, $("#" + id), datafield, round) + ")";
                ...
                for (var j = 0; j < CompuationFun.length; j++) {
                    if (CompuationFun[j].Accept(word)) {
                        executeExpress += CompuationFun[j].Compuator(this, $("#" + id), word, round);
                        break;
                    }
                }
            }
