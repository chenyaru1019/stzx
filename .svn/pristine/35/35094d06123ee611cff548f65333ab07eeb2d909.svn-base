...
(function ($) {
    ...
    $.MvcSheetUI.Controls.SheetCheckboxList.Inherit($.MvcSheetUI.IControl, {
        ...
        MobileInit: function () {
            ...
            //复选框控件使用
            if (this.Editable) {
                $(this.Element).parent().parent().bind("click.MobileCheckListBox", function () {
                    var template = $.MvcSheetUI.PortalRoot + '/Hybrid/form/templates/checkBoxList.html';
                    ionic.$scope.CheckListDisplay = that.CheckListDisplay;
                    ionic.$ionicPopup.show({
                        ...
                        },
                        {
                            ...
                            type: 'button-calm',
                            onTap: function (e) {
                                var val = that.MobileGetCheckListValue(ionic.$scope.CheckListDisplay)
                                console.dir();
                                that.SetValue(val);
                            }
                        }
        ...
        RenderMobile: function () {
            ...
            if (!this.Editable) {
                ...
                _Mask.insertAfter($(this.Element));
