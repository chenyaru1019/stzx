...
(function ($) {
    ...
    $.MvcSheetUI.Controls.SheetOffice = function (element, options, sheetInfo) {
        ...
        console.log("construct SheetOffice");
    ...
    $.MvcSheetUI.Controls.SheetOffice.Inherit($.MvcSheetUI.IControl, {
        ...
        AddTemplate: function () {
            ...
            // 将数据项的值替换到书签名
            // 注册KeyUp事件
            console.log("to add template");
            if (this.OnTemplate) {
                this.RunScript(this, this.OnTemplate);
            }
            else {
                this.NTKO.AddTemplateFromURL(this.Template);
                try {
                    var doc, curSel;
                    ...
                    for (var i = 0; i < this.bookmarks.length; i++) {
                        ...
                        console.log("update bookmark: " + this.bookmarks[i].Name + "=" + this.bookmarks[i].Value);
