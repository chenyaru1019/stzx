...
SheetDesigner.PropertyPanel.prototype = {
    ...
    _BindProperty: function (control, properties, parentControl, richProperty) {
        if (properties) {
            ...
            for (var i = properties.length - 1; i >= 0; i--) {
                ...
                html += this._GenerateWorkSheetContorlHtml(control.attr("id"), v, properties[i], richProperty);
                html += "</td>";
                html += "</tr>";
    ...
    _GenerateWorkSheetContorlHtml: function (controlId, propertyValue, sheetProperty, richProperty) {
