SheetControls = {
    SheetAttachment: {
        DesignProperties: [
            ...
            { Name: "AllowBatchDownload", Description: "获取或设置是否允许批量下载", DefaultValue: true, ValueRange: [true, false] },
            { Name: "FileExtensions", Description: "获取或设置附件上传的文件名格式,示例:.jpg,.gif", DefaultValue: "", ValueRange: null },
            { Name: "MaxUploadSize", Description: "获取或设置限制文件上传的大小(MB)，默认为 10MB", DefaultValue: 10, ValueRange: null }
        ]
    },
    SheetCheckbox: {
        DesignProperties: [
            { Name: "DataField", Description: "获取或设置控件绑定的数据项名称", DefaultValue: "", ValueRange: null },
            { Name: "DefaultValue", Description: "获取或设置控件的默认值", DefaultValue: false, ValueRange: [true, false] },
            { Name: "Text", Description: "获取或设置控件的文本说明", DefaultValue: "", ValueRange: null }
        ],
        DesignEvents: [
    ...
    SheetOffice: {
        DesignProperties: [
            ...
            { Name: "CABPath", Description: "获取或设置CABPath包所在的路径", DefaultValue: "Office/OfficeControl.cab", ValueRange: null },
            { Name: "ClassID", Description: "获取或设置绑定的NTKO给定的ClassID", DefaultValue: "A64E3073-2016-4baf-A89D-FFE1FAA10EC0", ValueRange: null },
            { Name: "ProductVersion", Description: "获取或设置绑定的NTKO给定的Version", DefaultValue: "5,0,1,6", ValueRange: null },
            { Name: "ProductCaption", Description: "获取或设置绑定的NTKO给定的ProductCaption", DefaultValue: "中海地产", ValueRange: null },
    ...
    SheetRichTextBox: {
        DesignProperties: [
            ...
            { Name: "VaildationRule", Description: "获取或设置控件的验证规则", DefaultValue: "", ValueRange: null },
    ...
    SheetTime: {
        ...
        DesignProperties: [
            { Name: "DataField", Description: "获取或设置控件绑定的数据项名称", DefaultValue: "", ValueRange: null },
            { Name: "DefaultValue", Description: "获取或设置当前控件的默认值", DefaultValue: "CurrentTime", ValueRange: null },
...
var SheetLanguages = {
    ...
    en_us: {
        ...
        SelectForwardUser: "Please select forward user",
        SelectAssistUser: "Please select assist user",
        AssistRemind: "Receive email after assist user submit or cancel.",
        ConsultRemind: "Receive email after consult user submit.",
        SelectConsultUser: "Please select consult user",
        SelectCirculateUser: "Please select circulate user",
        AllowCirculate: "Allow recirculate to other",
        SelectSignUser: "Please add an approve user",
