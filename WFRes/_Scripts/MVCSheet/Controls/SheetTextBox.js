...
(function ($) {
    ...
    $.MvcSheetUI.Controls.SheetTextBox.Inherit($.MvcSheetUI.IControl, {
        ...
        _mobilePopup: function () {
            ...
            console.log($(this)[0].SheetInfo.DisplayName);
            ...
            if (_that.Editable) {
                ...
                //     if ($(this)[0].SheetInfo.DisplayName == '因公出差'){
                //         $(this.Element).show();
                ...
                //         $('.ion-ios-arrow-right').unbind("click.query").bind("click.query", function () {
                //             console.log($(this).parent().prev().html())
                //             if($(this).parent().prev().html() == '姓名') {
                //                 $.MvcSheetUI.IonicFramework.$state.go("form.sheetquery", { datafield: _that.DataField, rownum: '2' });
                //             }else {
                //                 $.MvcSheetUI.IonicFramework.$state.go("form.sheetquery", { datafield: _that.DataField, rownum: '1' });
                //             }
                //         })
                //     }
...
// else {
                        ...
                        $(this.Element).parent().parent().unbind("click.query").bind("click.query", function () {
                            //跳转到查询页面
                            console.log($(this).find("[data-datafield='" + _that.DataField + "']").attr("data-row"))
