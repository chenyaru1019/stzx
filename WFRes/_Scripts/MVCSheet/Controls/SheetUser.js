...
(function ($) {
    ...
    $.MvcSheetUI.Controls.SheetUser.Inherit($.MvcSheetUI.IControl, {
        ...
        RenderMobile: function () {
            //baosc s
            //初始展示当前用户OU人员  包括虚拟用户
            if ($.MvcSheetUI.SheetInfo.UserOUMembers) {
            } else {
        ...
        SetValue: function (Obj) {
            ...
            if (Obj.constructor == Object) {
                this.AddChoice({ ObjectID: Obj.Code, Name: Obj.Name });
            } else if (Obj.constructor == Array) {
                for (var i = 0; i < Obj.length; i++) {
                    if (Obj[i].constructor == Object) {
                        this.AddChoice({ ObjectID: Obj[i].Code, Name: Obj[i].Name });
        ...
        HtmlRender: function () {
            ...
            if (this.SelectorPanel == null) {
                ...
                this.OrgTreePanel = $("<div>").css("max-width", "60%").addClass("bordered").css("float", "left").height("100%").css("overflow", "scroll");
