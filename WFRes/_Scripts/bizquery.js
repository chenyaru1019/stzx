        ...
        for (var i = 0; i < valuesArray.length; i++) {
            ...
            switch (type) {
                ...
                case 2://单选框
                    ...
                    filterInput += '<label><input name="' + code + '" type="radio" value="' + valuesArray[i].Text + '"  ' + checked + ' /> ' + valuesArray[i].Value + '</label>';
                    break;
                case 3://复选框
                    ...
                    filterInput += '<label><input name="' + code + '" type="checkbox" value="' + valuesArray[i].Text + '" ' + checked + '/> ' + valuesArray[i].Value + '</label>';
                    break;
            }
        }
    }
