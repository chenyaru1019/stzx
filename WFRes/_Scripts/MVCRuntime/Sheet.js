...
Sheet.prototype = {
    ...
    findControlByDataField: function (startObj, dataField) {
        var ctl = startObj.find("select[" + this.AttrDatafield + "='" + dataField + "'],div[" + this.AttrDatafield + "='" + dataField + "'],input[" + this.AttrDatafield + "='" + dataField + "'],span[" + this.AttrDatafield + "='" + dataField + "'],table[" + this.AttrDatafield + "='" + dataField + "']");
        if (ctl.length > 0) {
    ...
    getDataFieldValue: function (startObj, dataField) {
        var ctl = startObj.find("input[" + this.AttrDatafield + "='" + dataField + "'],select[" + this.AttrDatafield + "='" + dataField + "']");
        if (ctl.length > 0) {
            return ctl.val();
        }
