var module = angular.module('starter.controllers', [])
    // 全局Controller
    .controller("mainCtrl", function ($rootScope, $scope, $state, $http, $ionicPopup, $ionicSideMenuDelegate, $ionicPlatform, $ionicTabsDelegate, $cordovaDevice, $cordovaAppVersion, $cordovaNetwork, $ionicScrollDelegate, $cordovaToast, $cordovaBadge, $ionicHistory, commonJS) {
        console.log("主程序启动....");
        $scope.userId = "";
        //Tab栏待办待阅数
        $rootScope.badge = {
        ...
        $scope.getWorkItemUrl = function () {
            ...
            $scope.setting.tempImageUrl = url + "/TempImages/";
