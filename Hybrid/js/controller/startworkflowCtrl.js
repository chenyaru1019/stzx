module.controller('startworkflowCtrl', function ($rootScope, $scope, $http, $state, $ionicSideMenuDelegate,
    $ionicLoading, $ionicModal, $window, $ionicListDelegate, $ionicHistory, commonJS, focus) {
    //是否是常用标签页
    ...
    $scope.startWorkflow = function (workflowCode) {
        ...
        console.log($scope.setting.startInstanceUrl,workflowCode,$scope.clientInfo.UUID,$scope.user.MobileToken);
    };
